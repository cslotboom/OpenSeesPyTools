...
def test_AnimateXY_1():
    ...
    ani = opr.AnimateXY(x,y, fps = 24, rFactor = 2)
    assert True
    
    # return ani

def test_AnimateXY_2():
    ...
    # A plot of every second data point at 24 fps
    ani = opr.AnimateXY(x,y, fps = 24, skipStart = 300,  skipEnd = 500)
    assert True

def test_AnimateXY_3():
    ...
    # A plot of every second data point at 24 fps
    ani = opr.AnimateXY(x,y, fps = 24, rFactor = 2, outputFrames = 48)
    assert True
